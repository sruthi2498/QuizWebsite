...
con.connect(function(err) {
  ...
  console.log("Connected!");
	var sql="CREATE TABLE quiz_a (quiz_id INT,question_id INT AUTO_INCREMENT PRIMARY KEY, question VARCHAR(255), option1 VARCHAR(255), option2 VARCHAR(255), option3 VARCHAR(255), option4 VARCHAR(255), correct_option INT NOT NULL, num_correct INT DEFAULT 0,num_attempted INT DEFAULT 0)";
  con.query(sql, function (err, result) {
    if (err) throw err;
    console.log("Table created");
  });

var sql = "INSERT INTO quiz_a (question,option1,option2,option3,option4,correct_option,num_correct,num_attempted) VALUES ?";
  var values = [
...
var sql = "INSERT INTO animals (question,option1,option2,option3,option4,correct_option,num_correct,num_attempted) VALUES ?";
...
var sql = "INSERT INTO japan (question,option1,option2,option3,option4,correct_option,num_correct,num_attempted) VALUES ?";
